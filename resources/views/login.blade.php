...
<body>
    ...
    <div class="container mt-2" style="font-family: 'Times New Roman', Times, serif;">
        <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                ...
                <form action="{{ route('PhpSpreadsheetController.login') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input type="email" class="form-control" name="email" id="loginEmail" title="Enter your email" placeholder="Enter your email" onblur="check_email(this.id)" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" name="password" id="loginPassword" title="Enter your password" placeholder="Enter your password" required>
                        </div>
                    </div>
            ...
            <!-- Sign Up Form -->
            <div class="col-md-7 offset-md-1" style="font-family: 'Times New Roman', Times, serif;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="name" class="form-control" id="name" title="Enter your name" placeholder="Enter your name" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="organization" class="form-control" id="organization" title="Enter your organization" placeholder="Enter your organization" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="email" name="email" class="form-control" id="email" title="Email (Must be valid and it will be verified)" placeholder="Email (Must be valid and it will be verified)" onblur="check_email1(this.id)" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="password" name="password" class="form-control" id="password" title="Enter your password" placeholder="Enter your password" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="profession" class="form-control" id="profession" title="Enter your profession" placeholder="Enter your profession" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="purpose" class="form-control" id="purpose" title="Enter the purpose of your signup" placeholder="Enter the purpose of your signup" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="phone" class="form-control" id="phone" title="Enter your phone number" placeholder="Enter your phone number" required>
                                </div>
                            </div>
